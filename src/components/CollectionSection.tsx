...
const CollectionSection: React.FC = () => {
  ...
  return (
    <section id="collection" className="min-h-screen bg-zinc-800 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {collection.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-zinc-900 border border-zinc-700 aspect-square flex flex-col justify-center items-center p-8 relative overflow-hidden"
            >
              {index === 0 && (
                <>
                  <div className="absolute inset-0">
                    <img
                      src="/images/vfvsf.jpg"
                  ...
                  <div className="relative z-10 w-full h-full flex flex-col justify-center items-center">
                    <div className="text-center font-bold text-3xl md:text-4xl text-white tracking-wider mb-6">
                      SOLTRADERS
                    </div>
              ...
              {index !== 0 && (
                <>
                  <div className="text-center font-mono text-2xl md:text-3xl text-green-500 tracking-wider mb-6">
                    NO INFO
                  </div>
                  <div className="flex items-center justify-center space-x-4">
                    <a href="#" className="text-zinc-400 hover:text-white transition-colors duration-300" aria-label="X">
